...
class MeshDataEncoder:
    ...
    def _encode_gps(self, gps_data: Dict[str, float]) -> str:
        ...
        lat_int = int(round((lat + 90.0) * 1000000))  # Shift to positive range
        lon_int = int(round((lon + 180.0) * 1000000))  # Shift to positive range
    ...
    def _decode_gps(self, encoded_gps: str) -> Dict[str, float]:
        ...
        # Reverse the offset applied during encoding
        lat = (lat_int / 1000000.0) - 90.0
        lon = (lon_int / 1000000.0) - 180.0
