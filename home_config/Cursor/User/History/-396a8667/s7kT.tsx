          ...
          <div>
            ...
            <input
              ...
              onPaste={(e) => {
                ...
                if (data.onUpdate) {
                  data.onUpdate({ data: { ...data.data, url: pastedText } });
                }
              }}
              onKeyDown={(e) => {
                // Allow all keyboard shortcuts to work
                e.stopPropagation();
              }}
              onFocus={(e) => {
                e.stopPropagation();
          ...
          <div>
            ...
            <textarea
              ...
              onPaste={(e) => {
                ...
                const pastedText = e.clipboardData.getData('text');
                try {
                  const parsedHeaders = JSON.parse(pastedText);
                  if (data.onUpdate) {
                    data.onUpdate({ data: { ...data.data, headers: parsedHeaders } });
                  }
                } catch (error) {
                  // If pasted text is not valid JSON, just set it as raw text
                  if (data.onUpdate) {
                    data.onUpdate({ data: { ...data.data, headers: { "Content-Type": "application/json" } } });
                  }
                }
              }}
              onKeyDown={(e) => {
            ...
            <div>
              ...
              <textarea
                ...
                onPaste={(e) => {
                  ...
                  const pastedText = e.clipboardData.getData('text');
                  if (data.onUpdate) {
                    data.onUpdate({ data: { ...data.data, body: pastedText } });
                  }
                }}
                onKeyDown={(e) => {
                  e.stopPropagation();
