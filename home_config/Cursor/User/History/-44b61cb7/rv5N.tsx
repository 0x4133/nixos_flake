      ...
      message: 'Project saved automatically',
          ...
          React.useEffect(() => {
            const handleKeyDown = (event: KeyboardEvent) => {
              ...
              if (isInputField) {
                // Allow all keyboard events in input fields
                return;
              }

              // Only handle specific shortcuts when not in input fields
          ...
          }, [handleSave, handleRunGraph, selectedNodeId, removeNode, setSelectedNode]);
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex-1 relative" ref={reactFlowWrapper}>
            <ReactFlow
              ...
              onKeyDown={(e) => {
                // Only handle ReactFlow keyboard events when not typing in an input field
                ...
                // Let ReactFlow handle its own keyboard events for non-input fields
              }}
